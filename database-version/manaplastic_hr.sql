...
-- Thời gian đã tạo: Th10 28, 2025 lúc 02:37 PM
...
CREATE TABLE IF NOT EXISTS `attendances` (
  ...
  `status` enum('present','absent','late and early','on leave','missing output data','missing input data') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'absent',
...
(8, '2025-11-01', '2025-11-01 08:22:45', '2025-11-01 17:01:00', 'https://img.url/checkin_12_1.jpg', 'https://img.url/checkout_12_1.jpg', 'late and early', 1, 12),
(9, '2025-11-01', '2025-11-01 08:10:00', '2025-11-01 16:45:00', 'https://img.url/checkin_5_1.jpg', 'https://img.url/checkout_5_1.jpg', 'late and early', 1, 5),
(10, '2025-11-02', '2025-11-02 05:59:00', NULL, 'https://img.url/checkin_8_3.jpg', NULL, 'missing output data', 2, 8),
(11, '2025-11-02', NULL, '2025-11-02 17:05:00', NULL, 'https://img.url/checkout_9_1.jpg', 'missing input data', 1, 9),
(12, '2025-11-02', NULL, NULL, NULL, NULL, 'absent', 1, 6),
(13, '2025-11-02', NULL, NULL, NULL, NULL, 'on leave', 1, 10);
...
(1, 'admin', 'admin123', 'Trần Quản Trị', NULL, 'admin@manaplastic.com', NULL, NULL, NULL, NULL, NULL, NULL, '2023-01-01', 'active', 1, 2),
(2, 'it_support', 'it123', 'Lê Hỗ Trợ IT', NULL, 'it.support@manaplastic.com', NULL, NULL, NULL, NULL, NULL, NULL, '2023-05-10', 'active', 1, 2),
(3, 'hr_manager', 'hr123', 'Nguyễn Thị Nhân Sự', NULL, 'hr.manager@manaplastic.com', NULL, NULL, NULL, NULL, NULL, NULL, '2023-02-15', 'active', 2, 1),
(4, 'hr_staff', 'hr123', 'Phạm Văn Tuyển Dụng', NULL, 'hr.staff@manaplastic.com', NULL, NULL, NULL, NULL, NULL, NULL, '2023-08-01', 'active', 2, 1),
(5, 'kythuat_lead', 'ql123', 'Võ Văn Kỹ Thuật', NULL, 'kythuat.lead@manaplastic.com', NULL, NULL, NULL, NULL, NULL, NULL, '2023-03-01', 'active', 3, 3),
(6, 'kythuat_staff', 'nv123', 'Hoàng Thị Máy Móc', NULL, 'kythuat.staff@manaplastic.com', NULL, NULL, NULL, NULL, NULL, NULL, '2023-09-10', 'active', 4, 3),
(7, 'sanxuat_lead', 'ql123', 'Trịnh Hữu Sản Xuất', NULL, 'sanxuat.lead@manaplastic.com', NULL, NULL, NULL, NULL, NULL, NULL, '2023-03-02', 'active', 3, 4),
(8, 'sanxuat_staff', 'nv123', 'Đặng Văn Vận Hành', NULL, 'sanxuat.staff@manaplastic.com', NULL, NULL, NULL, NULL, NULL, NULL, '2023-09-15', 'active', 4, 4),
(9, 'inan_lead', 'ql123', 'Bùi Văn Mực', NULL, 'inan.lead@manaplastic.com', NULL, NULL, NULL, NULL, NULL, NULL, '2023-04-01', 'active', 3, 5),
(10, 'inan_staff', 'nv123', 'Lý Thị In', NULL, 'inan.staff@manaplastic.com', NULL, NULL, NULL, NULL, NULL, NULL, '2023-10-01', 'active', 4, 5),
(11, 'cskh_lead', 'ql123', 'Đỗ Thị Khách Hàng', NULL, 'cskh.lead@manaplastic.com', NULL, NULL, NULL, NULL, NULL, NULL, '2023-05-01', 'active', 3, 6),
(12, 'cskh_staff', 'nv123', 'Mạc Văn Hài Lòng', NULL, 'cskh.staff@manaplastic.com', NULL, NULL, NULL, NULL, NULL, NULL, '2023-11-01', 'active', 4, 6);
